...
PROJ = OpenStruct.new(
  ...
  :description => 'ActiveMessaging is an attempt to bring the simplicity and ' +
                  ...
                  'Messaging, (or event-driven architecture) is widely used ' +
                  'for enterprise integration, with frameworks such as ' +
                  'Java\'s JMS, and products such as ActiveMQ, Tibco, IBM ' + 
                  'MQSeries, etc.',
  :changes => nil,
